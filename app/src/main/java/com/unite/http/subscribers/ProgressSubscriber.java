package com.unite.http.subscribers;
...
import com.unite.http.exception.ApiException;
import com.unite.http.exception.CodeException;
import com.unite.http.exception.HttpTimeException;
import com.unite.http.http.cookie.CookieResulte;
import com.unite.http.listener.HttpOnNextListener;
import com.unite.http.utils.AppUtil;
import com.unite.http.utils.CookieDbUtil;
...
public class ProgressSubscriber<T> extends Subscriber<T> {
    ...
    private void errorDo(Throwable e) {
        ...
        if (e instanceof ApiException) {
            ...
            httpOnNextListener.onError(
                    new ApiException(
                            exception, CodeException.RUNTIME_ERROR, exception.getMessage()));
        } else {
            httpOnNextListener.onError(
                    new ApiException(e, CodeException.UNKNOWN_ERROR, e.getMessage()));
        }
    }
