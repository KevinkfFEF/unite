 ...
 * sharedpreference 工具包
 */
public class SPUtils {

    private static final String DEFAULT_NAME = "shared_name";
    private SharedPreferences sp;
    private SharedPreferences.Editor editor;

    public SPUtils(Context ctx, String fileName) {
        sp = ctx.getSharedPreferences(fileName, ctx.MODE_PRIVATE);
        editor = sp.edit();
    }

    public SPUtils(Context ctx) {
        sp = ctx.getSharedPreferences(DEFAULT_NAME, ctx.MODE_PRIVATE);
        editor = sp.edit();
    }
    ...
    public static void put(Context context, String name, String key, Object object) {
        ...
        if (TextUtils.isEmpty(name)) {
            sp = context.getSharedPreferences(DEFAULT_NAME,
    ...
    public static boolean contains(Context context, String key) {
        SharedPreferences sp = context.getSharedPreferences(DEFAULT_NAME,
                Context.MODE_PRIVATE);
